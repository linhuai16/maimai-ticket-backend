...
public class AdminIssueOrderItemVO {
    ...
    private LocalDateTime ticketUpdateTime;

    public AdminIssueOrderItemVO() {
    }
    ...
    public LocalDateTime getTicketCreateTime() {
        return ticketCreateTime;
    }

    public void setTicketCreateTime(LocalDateTime ticketCreateTime) {
        this.ticketCreateTime = ticketCreateTime;
    }

    public LocalDateTime getTicketUpdateTime() {
        return ticketUpdateTime;
    }

    public void setTicketUpdateTime(LocalDateTime ticketUpdateTime) {
